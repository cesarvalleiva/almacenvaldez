...
const Home = () => {
    const {altura, carrito, setCarrito, loading} = useContext(Context);
        ...
        <>
            {
                ...
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit = {{ opacity: 0}}>
                    <div className='avisoDispositivosGrandes'>
                        <p>Por favor ingresá desde el celular <span aria-label="celular" role="img">📱</span></p>
                    </div>
                    <div className='contenedorHome' style={{height: `${altura}px`}}>
                        <div className='secciones'>
                            <div className="accordion w-100" id="accordionExample">
                                <h3 className='w-100 text-center mt-1 mb-3 tituloSeccion'>Productos</h3>
                                {productos.length > 0 ? 
